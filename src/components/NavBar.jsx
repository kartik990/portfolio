...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      {/* hamburger */}
      <div onClick={handleNav} className="md:hidden z-10 cursor-pointer mr-y">
        {!nav ? <FaBars /> : <FaTimes />}
      </div>
      ...
      <ul
        className={
          nav
            ? `absolute top-0 left-0 w-full h-[120vh] pb-8 flex flex-col justify-center items-center bg-[#000000] md:hidden`
            : "hidden"
        }
      >
